...
public class LilypondAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected LilypondSwitch<Adapter> modelSwitch =
    new LilypondSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseMarkupBody(MarkupBody object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.elysium.lilypond.MarkupBody <em>Markup Body</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createMarkupBodyAdapter()
  {
    return null;
  }
