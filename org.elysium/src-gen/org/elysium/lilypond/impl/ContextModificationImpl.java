 ...
 * <ul>
 *   <li>{@link org.elysium.lilypond.impl.ContextModificationImpl#getBlock <em>Block</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContextModificationImpl extends MinimalEObjectImpl.Container implements ContextModification
{
  ...
  public NotificationChain basicSetBlock(UnparsedBlock newBlock, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LilypondPackage.CONTEXT_MODIFICATION__BLOCK, oldBlock, newBlock);
  ...
  public void setBlock(UnparsedBlock newBlock)
  {
    if (newBlock != block)
    {
      ...
      if (block != null)
        msgs = ((InternalEObject)block).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LilypondPackage.CONTEXT_MODIFICATION__BLOCK, null, msgs);
      if (newBlock != null)
        msgs = ((InternalEObject)newBlock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LilypondPackage.CONTEXT_MODIFICATION__BLOCK, null, msgs);
      msgs = basicSetBlock(newBlock, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LilypondPackage.CONTEXT_MODIFICATION__BLOCK, newBlock, newBlock));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LilypondPackage.CONTEXT_MODIFICATION__BLOCK:
