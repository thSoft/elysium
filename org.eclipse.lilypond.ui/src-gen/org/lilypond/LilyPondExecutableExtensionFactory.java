 ...
 * generated
 */
public class LilyPondExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(LilyPondExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		org.lilypond.internal.LilyPondActivator instance = org.lilypond.internal.LilyPondActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = org.lilypond.internal.LilyPondActivator.getInstance().getInjector("org.lilypond.LilyPond");
