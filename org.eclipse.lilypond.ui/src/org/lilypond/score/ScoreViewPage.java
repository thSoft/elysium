...
import org.lilypond.hyperlinks.ScoreToSourceHyperlink;
				...
				if (subtype == PdfDictionary.Link) {
					...
					try {
						...
						if (uri.getScheme().equals("textedit")) { //$NON-NLS-1$
							...
							Control scoreHyperlink = new ScoreToSourceHyperlink(hyperlinks, targetFilename, lineNumber, columnNumber);
