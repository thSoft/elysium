		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSchemeExpressionAccess().getQuotationsAlternatives_0_0(), "rule__SchemeExpression__QuotationsAlternatives_0_0");
					...
					put(grammarAccess.getTransposedMusicAccess().getGroup(), "rule__TransposedMusic__Group__0");
					...
					put(grammarAccess.getStringIndicationAccess().getGroup(), "rule__StringIndication__Group__0");
					...
					put(grammarAccess.getSourceFileNameAccess().getKeywordAssignment_1(), "rule__SourceFileName__KeywordAssignment_1");
					put(grammarAccess.getSourceFileNameAccess().getFilenameAssignment_2(), "rule__SourceFileName__FilenameAssignment_2");
					put(grammarAccess.getSourceFileLineAccess().getKeywordAssignment_1(), "rule__SourceFileLine__KeywordAssignment_1");
					put(grammarAccess.getSourceFileLineAccess().getLineAssignment_2(), "rule__SourceFileLine__LineAssignment_2");
					...
					put(grammarAccess.getTransposedMusicAccess().getKeywordAssignment_1(), "rule__TransposedMusic__KeywordAssignment_1");
					put(grammarAccess.getTransposedMusicAccess().getSourceAssignment_2(), "rule__TransposedMusic__SourceAssignment_2");
					put(grammarAccess.getTransposedMusicAccess().getTargetAssignment_3(), "rule__TransposedMusic__TargetAssignment_3");
					put(grammarAccess.getTransposedMusicAccess().getMusicAssignment_4(), "rule__TransposedMusic__MusicAssignment_4");
					...
					put(grammarAccess.getStringIndicationAccess().getStringAssignment_1(), "rule__StringIndication__StringAssignment_1");
					...
					put(grammarAccess.getSchemeExpressionAccess().getQuotationsAssignment_0(), "rule__SchemeExpression__QuotationsAssignment_0");
					put(grammarAccess.getSchemeExpressionAccess().getReferenceAssignment_1(), "rule__SchemeExpression__ReferenceAssignment_1");
